...
public class Actions : MonoBehaviour {
    ...
    // Returns the transaction hash. Use `WaitForTransaction` to wait for the transaction to be confirmed.
    public async Task<FieldElement> create_spell(Account account, FieldElement spell_id, SpellElement element, AttackSubtypeDojo attack_subtype, ushort damage, ushort knockback, ushort projectile_speed, ushort projectile_size, byte number_of_projectiles, short staggered_angle, ushort zigzag_amplitude, ushort zigzag_frequency, ushort homing_radius, ushort arc_gravity, ushort random_offset, ushort circular_speed, ushort circular_radius, ushort mana_cost, ushort cooldown) {
        List<dojo.FieldElement> calldata = new List<dojo.FieldElement>();
